...
<html lang="en">
  <head>
	...
	<link href="bootstrap/css/responsive-embed.less.css" rel="stylesheet">
  ...
  <body>
    ...
    <form class="form-search" action="scUserSearch.php" method="POST" id="searchForm">
		<div class="row">
		  <div class="col-lg-6">
